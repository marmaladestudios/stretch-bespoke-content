          ...
          <div class="aeo-scanner-features">
            ...
            <div class="aeo-scanner-feature-card">
              <div class="aeo-scanner-feature-icon aeo-scanner-feature-icon--blue">
                <svg viewBox="0 0 20 20" fill="none" width="18" height="18"><path d="M9.937 15.5A2 2 0 0 0 8.5 14.063l-6.135-1.582a.5.5 0 0 1 0-.962L8.5 9.936A2 2 0 0 0 9.937 8.5l1.582-6.135a.5.5 0 0 1 .963 0L14.063 8.5A2 2 0 0 0 15.5 9.937l6.135 1.581a.5.5 0 0 1 0 .964L15.5 14.063a2 2 0 0 0-1.437 1.437l-1.582 6.135a.5.5 0 0 1-.963 0z" stroke="currentColor" stroke-width="1.5"/><path d="M20 3v4" stroke="currentColor" stroke-width="1.5"/><path d="M22 5h-4" stroke="currentColor" stroke-width="1.5"/></svg>
              </div>
              <div>
