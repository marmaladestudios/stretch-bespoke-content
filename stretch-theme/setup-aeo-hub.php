...
if (defined('WP_CLI') && WP_CLI) {
    WP_CLI::log("AEO hub content saved to option: stretch_hub_aeo");
    WP_CLI::log("Chapters: " . count($aeo_hub['chapters']));
    WP_CLI::log("Sections: " . count($aeo_hub['sections']));
} else {
    echo "AEO hub content saved to option: stretch_hub_aeo\n";
    echo "Chapters: " . count($aeo_hub['chapters']) . "\n";
